...
##  Эксперимент
Температура при смешении идеальных газов может быть рассчитана как средневзвешенная температура двух или более компонентов с учетом их количества частиц. В случае смешения двух идеальных газов, температура смеси определяется следующим образом:

$$ 
T_{mix} = \frac{N_{1} \cdot T_{1} + N_{2} \cdot T_{2}}{N_{1} + N_{2}} 
$$

Сравним это с результатами моделирования:

| Температура левого | Температура правого | Количество частиц левого | Количество частиц правого | Теория | Практика |
|--------------------|---------------------|--------------------------|---------------------------|--------|----------|
| 300K               | 100K                | 500                      | 500                       | 200К   | 198.251К |
| 300K               | 100K                | 1000                     | 500                       | 233К   | 226.226К |
| 300K               | 300K                | 1000                     | 500                       | 300К   | 287.177К |
| 300K               | 100K                | 1000                     | 700                       | 217К   | 213.951К |
| 300K               | 100K                | 1000                     | 700                       | 217К   | 213.951К |

Пример графика установления температуры:
